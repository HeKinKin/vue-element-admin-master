<template>
  <div class="crm" style="background-color:#FFFFFF;box-shadow: 2px 2px 5px #888888;overflow:
    ...
    <div>
      ...
      <div style="margin-left: 10px;margin-top: 15px">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          <!--<span style="font-size: 14px">*优惠券名称:</span>-->
          <el-form-item label="券模板名称" prop="couponName">
            <el-input v-model="ruleForm.couponName" placeholder="请输入券模板名称" style="width: 200px" size="mini"></el-input>
            <br/>
          </el-form-item>
          <el-form-item label="优惠券类型" prop="typeCoupon">
            <el-select v-model="ruleForm.typeCoupon" placeholder="选择类型" size="mini" style="margin-top: 10px;width: 200px "
                       @change="changeType()">
              <el-option
    ...
    <!--使用规则-->
    <div style="padding-top: 12px;background-color: #f2f2f2;height: 35px ">
        <span style="float:left;padding-top:-20px;color:#C0C0C0;margin-left:1%">
               <h style="font-size: 20px;">使用规则</h>
        </span>
    </div>
    <div>
      <el-form ref="form" :rules="rulesForm2" :model="form" label-width="80px"  size="mini" style="margin: 10px">
        ...
        <el-form-item label="折扣券:" v-if="form.replaceDiscount" label-width="100px">
          <el-input v-model.trim="form.amount" style="width: 180px"></el-input>
          <span>折    满</span>
          <el-input v-model="form.thresholdMoney" style="width: 180px"></el-input>
          <span>可用</span>
        </el-form-item>
        ...
        <el-form-item label="*活动时间" v-if="form.fixedTime">
          ...
          <el-col :span="11">
            <el-date-picker type="date" placeholder="选择结束日期" format="yyyy-MM-dd" value-format="yyyy-MM-dd"
                            v-model="form.effectiveEndDate" style="width: 60%;"></el-date-picker>
          </el-col>
        </el-form-item>
        ...
        <el-form-item label="日期" v-if="form.showWeekday">
          ...
          <el-col :span="8">
            <el-time-picker type="date" placeholder="选择时间" v-model="form.effectiveStartTime" format="HH-mm-ss"
                            value-format="HH-mm-ss" style="width: 180px;"></el-time-picker>
          </el-col>
          <el-col class="line" :span="2">选择结束日期</el-col>
          <el-col :span="8">
            <el-time-picker type="date" placeholder="选择时间" v-model="form.effectiveEndTime" format="HH-mm-ss"
                            value-format="HH-mm-ss" style="width: 180px;"></el-time-picker>
          </el-col>
        </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      onSubmit() {
        ...
        console.log('cookie中的值为：' + sendInfo.crmMerchantId);
        sendInfo.$axios({
          method: 'post',
          url: 'http://localhost:61116/template/insertCouponTemplate',
          data: {
            'header': {},
            'body': {
          ...
          sendInfo.$message.success('创建成功');
          sendInfo.$router.push('/campaign/couponTemplate');
        })
      }
    }
  }
