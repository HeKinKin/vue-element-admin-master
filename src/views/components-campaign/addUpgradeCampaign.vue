        ...
        <el-tabs v-model="editableTabsValue2" type="card" closable @tab-remove="removeTab">
          ...
          >
            <el-form :inline="true" :model="formInline" class="demo-form-inline"  >
              ...
              <!--<el-form-item label="升级到">-->
                <!--<el-select v-model="item.levelUpCode" style="width: 150px" size="mini" placeholder="请选择升级等级" clearable>-->
                  <!--<el-option-->
  ...
  export default {
    ...
    methods: {
      ...
      getLevel() {
        ...
        workThis.$axios({
          method: 'post',
          url: 'http://localhost:61116/ipos/campaign/getLevel',
          data: {
            'body': {
          ...
          // for (let k = 0; k < workThis.options.length - 1; k++) {
          //   workThis.level1.push(workThis.options[k])
          // }
        })
      },
      // getNextValue() {
        ...
        workThis.$refs.rulesForm.validate((valid) => {
          if (valid) {
            workThis.$axios({
              ...
              if (workThis.responseCode === '11120') {
                workThis.$message({
                  type: 'warning',
                  message: workThis.responseMess
                });
